...
-- ExportedAt: 2026-09-10T03:02:18.599Z
-- Tables: 25
-- Rows: 91
-- Format: Aura-SQL-1
...
INSERT INTO "user_sessions" ("id", "user_id", "type", "ip_address", "user_agent", "created_at") VALUES (8, 1, 'login', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.7680.216 Electron/41.7.1 Safari/537.36', 1789009328);
CREATE TABLE `users` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
