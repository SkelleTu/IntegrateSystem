      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          {metrics.map((m, i) => (
            <div key={i} className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 relative group hover:border-primary/40 transition-all flex flex-col items-center text-center">
              ...
              <p className="text-5xl font-black text-white mb-2 italic">{m.value}</p>
        ...
        <div className="space-y-16">
          <div className="text-center">
            <h2 className="text-3xl font-black italic uppercase tracking-tight mb-4">Fundamentos da Performance</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {pillars.map((p, i) => (
              <div key={i} className="space-y-4">
                <h3 className="text-xl font-black uppercase italic text-primary">{p.title}</h3>
        ...
        <div className="mt-32 p-12 rounded-[3rem] bg-primary/5 border border-primary/20 relative overflow-hidden text-center">
          ...
          <h2 className="text-2xl md:text-4xl font-black italic uppercase mb-6 tracking-tighter">Pronto para elevar o nível?</h2>
          ...
          <button className="bg-primary text-white font-black italic uppercase px-12 h-16 text-lg rounded-xl hover:scale-105 transition-transform shadow-[0_0_30px_rgba(0,229,255,0.4)]">
            SOLICITAR ACESSO
          </button>
        </div>
      </div>
